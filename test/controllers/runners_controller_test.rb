...
class RunnersControllerTest < ActionController::TestCase
  ...
  test "should create runner" do
    assert_difference('Runner.count') do
      post :create, runner: { age: @runner.age, bio: @runner.bio, country: @runner.country, email: @runner.email, name: @runner.name }
    end
  ...
  test "should update runner" do
    patch :update, id: @runner, runner: { age: @runner.age, bio: @runner.bio, country: @runner.country, email: @runner.email, name: @runner.name }
    assert_redirected_to runner_path(assigns(:runner))
  end
