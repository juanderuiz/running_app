...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { nombre: @shoe.nombre, runner_id: @shoe.runner_id, totalkms: @shoe.totalkms }
    end
  ...
  test "should update shoe" do
    patch :update, id: @shoe, shoe: { nombre: @shoe.nombre, runner_id: @shoe.runner_id, totalkms: @shoe.totalkms }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
